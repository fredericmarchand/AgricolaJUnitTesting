...
public class AgricolaController extends JFrame implements  MouseListener, ActionListener{
	...
	private JButton[][] b;
	private Space[][][] farm;
	private JButton b_room, b_start, b_grain, b_field, b_stable, b_day, b_wood, b_clay, b_reed, b_food, b_sheep, b_sow, b_fences, b_improve, b_stone, 
					b_growth, b_renov, b_boar, b_vege,b_cattle, b_stone2, b_growth2, b_fieldsow, b_renov2, 
					b3_clay, b3_2wood, b3_resource, b3_resource2,
					b4_wood,b4_2clay,b4_2wood,b4_food,b4_resource,b4_3resource,
					b5_4wood,b5_3clay, b5_roomfood,b5_reed,b5_animals,b5_resource;
	...
	private int turn, wood, clay, reed, food, sheep, stone, stone2, boar, cattle,
				clay_3p, wood2_3p, wood_4p, wood2_4p, clay2_4p, food_4p, wood4_5p, clay3_5p, food_5p, reed_5p;
	private int cur_player, start_player, view_player;
	@SuppressWarnings("unused")
	private boolean wField, wRoom, wStableRoom, wStable, wRoom2, wSow, wFieldSow, wFences, wSheep, wBoar, wCattle, wField2;
    ...
    public AgricolaController(){
    	...
    	Object[] possibilities = {"Human", "Computer - Normal", "Computer - Hard"};
		String s = (String)JOptionPane.showInputDialog(null,"Please Select Player 1","Setup Game",JOptionPane.PLAIN_MESSAGE, null, possibilities,"Human");
    	if (s.equals("Human"))
			num_players++;
    	
    	
    	Object[] possibilities2 = {"Human", "Computer - Normal", "Computer - Hard", "No More Players"};
    	
		s = (String)JOptionPane.showInputDialog(null,"Please Select Player 2","Setup Game",JOptionPane.PLAIN_MESSAGE, null, possibilities2,"Human");
		if (!s.equals("No More Players")){
		if (s.equals("Human"))
			num_players++;
		
		
		s = (String)JOptionPane.showInputDialog(null,"Please Select Player 3","Setup Game",JOptionPane.PLAIN_MESSAGE, null, possibilities2,"Human");
		if (!s.equals("No More Players")){
		if (s.equals("Human"))
			num_players++;
		s = (String)JOptionPane.showInputDialog(null,"Please Select Player 4","Setup Game",JOptionPane.PLAIN_MESSAGE, null, possibilities2,"Human");
		if (!s.equals("No More Players")){
		if (s.equals("Human"))
			num_players++;
		s = (String)JOptionPane.showInputDialog(null,"Please Select Player 5","Setup Game",JOptionPane.PLAIN_MESSAGE, null, possibilities2,"Human");
		if (!s.equals("No More Players")){
    	if (s.equals("Human"))
			num_players++;
	...
	public void actionPerformed(ActionEvent e){
    	...
    	if (e.getSource() instanceof JButton){
    		...
    		if (e.getActionCommand().equals("Build rooms [5 wood/clay/stone and 2 reed] and/or build stables [2 wood]")){
    			
    			Object roomorstable[] = {"Build Room","Build Stable"};
    			
    			 int selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", 
        ...
        null, roomorstable, roomorstable[0]);
    			...
    			if (selectedValue==0){
	    			...
	    			if (players[cur_player].getReed()<2)
	    				JOptionPane.showMessageDialog(null, "Not enough reed", "insufficient resources", JOptionPane.ERROR_MESSAGE);
	    
	    			else if (players[cur_player].getRoomType()=='w'){
	    				if (players[cur_player].getWood()<5)
	    					JOptionPane.showMessageDialog(null, "Not enough wood", "insufficient resources", JOptionPane.ERROR_MESSAGE);
	    				else 
	    					wRoom=true;
	    				...
	    				if (players[cur_player].getClay()<5)
	    					JOptionPane.showMessageDialog(null, "Not enough clay", "insufficient resources", JOptionPane.ERROR_MESSAGE);
	    				else 
	    					wRoom=true;
	    				...
	    				if (players[cur_player].getStone()<5)
	    					JOptionPane.showMessageDialog(null, "Not enough stone", "insufficient resources", JOptionPane.ERROR_MESSAGE);
	    				else 
	    					wRoom=true;
    		...
    		else if (e.getActionCommand().equals("Starting Player and take 1 Food")){
    		...
    		else if (e.getActionCommand().equals("Build 1 Stable [1 wood] and/or Bake Bread")){
    			Object stabbread[] = {"Build Stable","Bake Bread"};
    			
    						 int selectedValue = JOptionPane.showOptionDialog(null, "Choose Action", "Choose one", 
      						  JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
    		...
    		else if (e.getActionCommand().equals("Take 1 food and 1 wood, clay, reed, or stone")){
    ...
    int selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", 
        ...
        null, possibleValues, possibleValues[0]);
    			...
    			Object[] possibleValues =  {"Sow Grain", "Sow Vegetable", "Bake Bread", "Done Action"};
    			while (selectedValue!=3){
    			
    			
    				selectedValue = JOptionPane.showOptionDialog(null, "Choose Action", "Choose one", 
	      			  JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
	      			  null, possibleValues, possibleValues[0]);
	    				...
	    				if (players[cur_player].getGrain()>0){
		    				...
		    				for (int r=0;r<7;r++){
								for (int col=0;col<11;col++){
									...
									if (farm[cur_player][r][col].getType()=='f'&&farm[cur_player][r][col].getStack()==0&&tempcontinue){
    		...
    		else if (e.getActionCommand().equals("Build Fences [1 wood per fence]")){
    			wFences=true;
    		...
    		else if (e.getActionCommand().equals("Take 1 stone (+1 per round)")){
    			b_stone.setVisible(false);
    			...
    			if (players[cur_player].getRooms()==players[cur_player].getFamily())
    				JOptionPane.showMessageDialog(null, "You must have an unoccupied room to grow your family", "No room", JOptionPane.ERROR_MESSAGE);
    			else {
    		...
    		else if (e.getActionCommand().equals("Renovate [1 reed plus 1 clay/stone per room] also 1 Major Improvement")){
    			if  (players[cur_player].getReed()>0){
    			
    			
	    			if (farm[cur_player][3][1].getType()=='w'){
	    				if (players[cur_player].getClay()<players[cur_player].getRooms()){
	    					JOptionPane.showMessageDialog(null, "Not enough Clay", "insufficient resources", JOptionPane.ERROR_MESSAGE);
	    				}
	    				else {
	    					players[cur_player].useFam();
	    					...
	    					players[cur_player].addClay(-(players[cur_player].getRooms()));
	    					players[cur_player].addReed(-1);
	    					for (int r=0;r<7;r++){
								for (int col=0;col<11;col++){
	    				...
	    				if (players[cur_player].getStone()<players[cur_player].getRooms()){
	    					JOptionPane.showMessageDialog(null, "Not enough Stone", "insufficient resources", JOptionPane.ERROR_MESSAGE);
	    				}
	    				else {
	    					...
	    					players[cur_player].addStone(-(players[cur_player].getRooms()));
	    					players[cur_player].addReed(-1);
	    					for (int r=0;r<7;r++){
								for (int col=0;col<11;col++){
    		...
    		else if (e.getActionCommand().equals("Take wild boar (+1 per turn)")){
    			b_boar.setVisible(false);
    		...
    		else if (e.getActionCommand().equals("Family Growth (even without space in your home)")){
    			b_growth2.setVisible(false);
    			players[cur_player].addFamily();
    			players[cur_player].useFam();
    			...
    			Object plowchoice[] = {"Plow(Select First)","Sow Grain", "Sow Vegetable", "Done Action"};
    			boolean tempcontinue;
    			 int selectedValue=0;
    			while (selectedValue!=3){
    		...
    		else if (e.getActionCommand().equals("Renovate (1 reed plus 1 clay/stone per room) also Fences [1 wood]")){
    			if  (players[cur_player].getReed()>0){
    		...
    		//3 player only commands
    			...
    			Object[] possibleValues4 =  {"Wood", "Clay", "Reed", "Stone"};
   				int selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
    		...
    		else if (e.getActionCommand().equals("(3p) 2 Different Building Resources")){
    			...
    			if (selectedValue==0){
    				...
    				selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
       								 null, possibleValuesWood, possibleValuesWood[0]);
       				if (selectedValue==0){
    				players[cur_player].addClay(1);
	    			}
	    			else if (selectedValue==1)
    				...
    				selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
       								 null, possibleValuesClay, possibleValuesClay[0]);
       				if (selectedValue==0){
    				players[cur_player].addWood(1);
	    			}
	    			else if (selectedValue==1)
    				...
    				selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
       								 null, possibleValuesReed, possibleValuesReed[0]);
       				if (selectedValue==0){
    				players[cur_player].addWood(1);
	    			}
	    			else if (selectedValue==1)
    				...
    				selectedValue = JOptionPane.showOptionDialog(null, "Take Resource", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
       								 null, possibleValuesStone, possibleValuesStone[0]);
       				if (selectedValue==0){
    				players[cur_player].addWood(1);
	    			}
	    			else if (selectedValue==1)
    		...
    		else if (e.getActionCommand().equals("(4p) 2 Different Building Resources")){
    		...
    		//***********************
    		...
    		else if (e.getActionCommand().equals("(5p) Build 1 room or take Food (+1 per round)")){
    			//b5_roomfood.setVisible(false);
    			
    			Object[] possibleValuesRoomFood =  {"Build 1 Room" , "Take Food"};
   				int selectedValue = JOptionPane.showOptionDialog(null, "Action", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
       								 null, possibleValuesRoomFood, possibleValuesRoomFood);
    			if (selectedValue==0){
    				if (players[cur_player].getReed()<2)
    				JOptionPane.showMessageDialog(null, "Not enough reed", "insufficient resources", JOptionPane.ERROR_MESSAGE);
    		...
    		else if (e.getActionCommand().equals("(5p) Take Reed (+1 per round) & 1 stone + 1 wood")){
    		...
    		else if (e.getActionCommand().equals("(5p) Take Animal - sheep gives 1 food, cattle costs 1")){
    			Object[] possibleValuesAnimals =  {"Sheep+Food" , "Boar", "Cattle-Food"};
   				int selectedValue = JOptionPane.showOptionDialog(null, "Choose Animal", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
    			...
    			if (selectedValue==0){
    				...
    				if (players[cur_player].getFood()<1)
    					JOptionPane.showMessageDialog(null, "Not enough Food", "Need 1 Food", JOptionPane.ERROR_MESSAGE);
    				else{
    					b5_animals.setVisible(false);
    		...
    		else if (e.getActionCommand().equals("(5p) 2 Different Building Resources or Family Growth")){
    			
    			Object[] possibleChoice2 = {"Resources" , "Growth"};
    			int selectedValue2 = JOptionPane.showOptionDialog(null, "Choose", "Choose one", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
       								 null, possibleChoice2, possibleChoice2[0]);
    			...
    			if (selectedValue2==0){
    				...
    				if (game<5)
    					JOptionPane.showMessageDialog(null, "Growth can only be taken from round 5 onwards", "Too Early", JOptionPane.ERROR_MESSAGE);
    					
	    			else if (players[cur_player].getRooms()==players[cur_player].getFamily())
	    				JOptionPane.showMessageDialog(null, "You must have an unoccupied room to grow your family", "No room", JOptionPane.ERROR_MESSAGE);
	    			else {
    		...
    		//**************************************
    			...
    			if (wField){
    				if (farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].getType()=='e'
    					&&farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].isSquare()){
			    	...
			    	//players[cur_player].useFam();
			    	//System.out.println((((JButton)e.getSource()).location().y/110)*2+1 + " " + (((JButton)e.getSource()).location().x/118)*2+1);
			    	farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].setType('f');
			    	update(false);
    			...
    			if (wRoom){
    				if (farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].getType()=='e'
    					&&farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].isSquare()){
    						...
    						players[cur_player].decEmpty(1);
    						farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].setType(farm[cur_player][3][1].getType());
    						...
    						Object roomdone[] = {"Build Room","Build Stable","Done Action"};
    			
    						 int selectedValue = JOptionPane.showOptionDialog(null, "Choose Action", "Choose one", 
      						  JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
      						  null, roomdone, roomdone[0]);
    			...
    			if (wStable){
    				if (farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].getType()=='e'
    					&&farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].isSquare()){
    						...
    						farm[cur_player][((JButton)e.getSource()).location().y/110*2+1][((JButton)e.getSource()).location().x/118*2+1].setType('p');
    						Object stabdone[] = {"Build Room","Build Stable","Done Action"};
    			...
    			if (wField2){
			    	...
			    	Object plowchoice[] = {"Sow Grain", "Sow Vegetable", "Done Action"};
    			boolean tempcontinue;
    			 int selectedValue=0;
    	...
    	//	JOptionPane.showMessageDialog(this, "Command: " + e.getActionCommand());
    	...
    	if (e.getSource() instanceof JButton){
    		if (e.getActionCommand().equals("Administrator")){
    			LoginDialogBox login=new LoginDialogBox(this);
    			login.setVisible(true);
    			if (login.isAdmin()){
    				SeatInfoDialogBox info=new SeatInfoDialogBox (this,sold,total);
    		...
    		if (e.getActionCommand().equals("Purchase")){
    			String seatspurchased = "";
    			int temp=0;
    			for (int r=0;r<27;r++){
    				for (int col=0;col<35;col++){
    					if (b[r][col].getBackground()==Color.black){
    					seatspurchased = seatspurchased + Character.toString(seating[r][col].getSection()) + Character.toString(seating[r][col].getRow()) + Character.toString(seating[r][col].getNumber()) + " ";
    					temp++;
    					}
    				}
    			}
    			if (temp==0)
    				JOptionPane.showMessageDialog(null, "Please choose at least one seat to purchase them.", "No Seats Chosen", JOptionPane.INFORMATION_MESSAGE);
    			else {
    				PurchaseDialogBox p = new PurchaseDialogBox(this);
    				p.setVisible(true);
    				if (p.getPurchase()){
    					if (game==5)
    						System.out.print("Receipt:\nSeats Purchased for all games: "+ seatspurchased + "\n" + p + "\n\nTotal Cost: $" + view.getTexts()[3].getText()+ "\n");
    					else 
    						System.out.print("Receipt:\nSeats Purchased for game "+ game +": " + seatspurchased + "\n" + p + "\n\nTotal Cost: $" + view.getTexts()[3].getText()+ "\n");
	        			total[game-1] = total[game-1] + Float.valueOf(view.getTexts()[3].getText());
	        			sold[game-1] = sold[game-1] + temp;
	    				update(true);
    				}
    			}
    			...
    			Seat seat=seating[((JButton)e.getSource()).location().y/17][((JButton)e.getSource()).location().x/18];
    			float cost=Float.valueOf(seat.getPricing(seat.getSection()-49));
    			if (game==5)
    				cost=(cost*4)*0.9f;
    			if (selection.getBackground()==Color.black){
    				changeButton(seat,selection);
    				view.getTexts()[0].setText(String.format("%.2f", Float.valueOf(view.getTexts()[0].getText()) - cost));
    			}
    			else {
    			...
    			view.getTexts()[1].setText(String.format("%.2f", Float.valueOf(view.getTexts()[0].getText()) * 0.08));
	    		view.getTexts()[2].setText(String.format("%.2f", Float.valueOf(view.getTexts()[0].getText()) * 0.05));
	    		view.getTexts()[3].setText(String.format("%.2f", Float.valueOf(view.getTexts()[0].getText()) + Float.valueOf(view.getTexts()[1].getText()) + Float.valueOf(view.getTexts()[2].getText())));    	
    		...
    		if (e.getActionCommand().equals("All Games")){
    			game=5;
    			update(false);
    		}
    ...
    //******************************************
    //After every action, update is called to change players and process new round changes if everyone is out of family members
    //******************************************
    public void update(boolean newround){
    	...
    	for (int i=0;i<num_players;i++)
  		...
  		if (sum==0){
  			...
  			if (turn==4||turn==7||turn==9||turn==11||turn==13||turn==14){
  				for (int p=0;p<num_players;p++){
	  				for (int r=0;r<7;r++){
						for (int col=0;col<11;col++){
							...
							if (farm[p][r][col].getType()=='g'&&farm[p][r][col].getStack()>1){
								farm[p][r][col].decStack();
								if (farm[p][r][col].getStack()==0)
									farm[p][r][col].setType('f');
								players[p].addGrain();
								}
							if (farm[p][r][col].getType()=='v'&&farm[p][r][col].getStack()>1){
								farm[p][r][col].decStack();
								if (farm[p][r][col].getStack()==0)
									farm[p][r][col].setType('f');
								players[p].addVege();
			    		...
			    		int selectedValue=0;
			    		Object harvestopt[] = {"Convert Grain","Convert Vegetable","Convert Sheep","Convert Boar" ,"Convert Cattle", "Done"};
    					
    					
    					while (selectedValue!=5){
    					
    						 selectedValue = JOptionPane.showOptionDialog(null, "Choose actions before Harvest", "Harvest", 
      						  JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
      						  null, harvestopt, harvestopt[0]);
      						  
      						  if (selectedValue==0&&players[p].getGrain()>0){
      						  	players[p].decGrain();
      						  	players[p].addFood(1);
      						  }
      						  else if (selectedValue==1&&players[p].getVege()>0){
      						  ...
      						  else if (selectedValue==2&&players[p].getSheep()>0){
      						  	if (players[p].hasOven()){
      						  ...
      						  else if (selectedValue==4&&players[p].getCattle()>0){
      						  	if (players[p].hasOven()){
    					...
    					if (players[p].getFood()<players[p].getFamily()*2){
    						...
    						players[p].addScore(((players[p].getFamily()*2)-players[p].getFood())*3);
  				...
  				if (turn==14){
  					if (num_players==1){
    					...
    					"Final Score: " + players[0].getScore());
  					}
    				...
    				if (num_players==3){
    					...
    					JOptionPane.showMessageDialog(null,
    					"Final Scores\nPlayer1: " + players[0].getScore() + "\nPlayer 2: " + players[1].getScore()+ "\nPlayer 3: " + players[2].getScore());	
    				}
    				if (num_players==4){
 
    					JOptionPane.showMessageDialog(null,
    					"Final Scores\nPlayer1: " + players[0].getScore() + "\nPlayer 2: " + players[1].getScore()+ "\nPlayer 3: " + players[2].getScore()+ "\nPlayer 4: " + players[3].getScore());	
    				}
    				if (num_players==5){
 
    					JOptionPane.showMessageDialog(null,
    					"Final Scores\nPlayer1: " + players[0].getScore() + "\nPlayer 2: " + players[1].getScore()+ "\nPlayer 3: " + players[2].getScore()+ "\nPlayer 4: " + players[3].getScore()+ "\nPlayer 5: " + players[4].getScore());	
    				}
      	...
      	view.getPlayerTexts()[0].setText(Integer.toString(players[cur_player].getFood()));
    	view.getPlayerTexts()[1].setText(Integer.toString(players[cur_player].getReed()));
    	view.getPlayerTexts()[2].setText(Integer.toString(players[cur_player].getWood()));
    	view.getPlayerTexts()[3].setText(Integer.toString(players[cur_player].getClay()));
    	view.getPlayerTexts()[4].setText(Integer.toString(players[cur_player].getStone()));
    	view.getPlayerTexts()[5].setText(Integer.toString(players[cur_player].getGrain()));
    	view.getPlayerTexts()[6].setText(Integer.toString(players[cur_player].getVege()));
    	view.getPlayerTexts()[7].setText(Integer.toString(players[cur_player].getFamily()));
    	view.getPlayerTexts()[8].setText(Integer.toString(players[cur_player].getActiveFamily()));
    	view.getPlayerTexts()[9].setText(Integer.toString(players[cur_player].getSheep()));
    	view.getPlayerTexts()[10].setText(Integer.toString(players[cur_player].getBoar()));
    	view.getPlayerTexts()[11].setText(Integer.toString(players[cur_player].getCattle()));
    ...
    /*	for (int r=0;r<27;r++){
    		for (int col=0;col<35;col++){
    			if (bought){
    				if ((b[r][col].getBackground()==Color.black) && (game==5)){
    					for (int count=0;count<4;count++)
    						seating[r][col].getBought()[count]=true;
    				}
    				else {
    					if (b[r][col].getBackground()==Color.black)
    ...
    /*	System.out.println(" player 1: " +farm[0][1][1].getType());
    	...
    	b[3][3].setBackground(Color.black);
    		...
    		for (int r=0;r<7;r++){
				for (int col=0;col<11;col++){
					//e= empty, w=wood room, p=pasture, c=clay room, s=stone room, f=field, g=grain field, v=vege field, x=fence
				
					

					if (farm[view_player][r][col].getType()=='e'&&farm[view_player][r][col].isSquare())
