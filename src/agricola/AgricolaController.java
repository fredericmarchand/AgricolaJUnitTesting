...
public class AgricolaController extends JFrame implements MouseListener,
	...
	// public Player player,player1,player2,player3,player4,player5;
	...
	public JRadioButtonMenuItem mplayer1, mplayer2, mplayer3, mplayer4,
			mplayer5;
	public int[] sold;
	public float[] total;
	public Space seat_text;
	public int game, num_players;
	...
	public int cur_player, start_player, view_player;
	...
	/*  selectedValue: 0 = room, 1 = stable 
	 *  return value:  1 = missing resources */
	public int buildRoomsStables(int selectedValue) {
